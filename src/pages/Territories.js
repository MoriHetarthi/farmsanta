...
function Territories() {
    return (
        <>
            <div className="containers" style={{backgroundColor: "rgb(239,239,239)"}}>
                        ...
                        <table class="table align-middle">
                            <thead class="thead-light" style={{ backgroundColor: '#f0f8f7' }}>
                                <tr>
                                    ...
                                    <th className="col-2" scope="col">Territory name</th>
                                    <th className="col-2" scope="col">Country</th>
                                    <th className="col-2" scope="col">Language</th>
                            ...
                            <tbody>
                                <tr style={{ color: 'rgb(128, 128, 128)' }}>
                                    ...
                                    <td>
                                        Description Officially the Republic of Cameroon, is a country
                                        in west-central Africa. It is bordered by Nigeria to the west
                                        and north, Chad to the northeast; the Central African Republic
                                        to the east.
                                    </td>
                                ...
                                <tr style={{ color: 'rgb(128, 128, 128)' }}>
                                    ...
                                    <td>
                                        Description Officially the Republic of Kenya, is a country
                                        in west-central Africa. It is bordered by Nigeria to the west
                                        and north, Chad to the northeast; the Central African Republic
                                        to the east.
                                    </td>
                                ...
                                <tr style={{ color: 'rgb(128, 128, 128)' }}>
                                    ...
                                    <td>English,Swahili</td>
                                    <td>
                                        Description Officially the Republic of Uganda, is a country
                                        in west-central Africa. It is bordered by Nigeria to the west
                                        and north, Chad to the northeast; the Central African Republic
                                        to the east.
                                    </td>
